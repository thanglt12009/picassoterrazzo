 ...
 * @return void
 */
function white_label_remove_admin_color_schemes()
{
...
add_action('admin_init', 'white_label_remove_admin_color_schemes', 1);
...
function white_label_admin_color_scheme()
{
    ...
    $submenu_text = hex_tint($menu_text, -10);
