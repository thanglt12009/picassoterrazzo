...
class white_label_Admin_Settings
{
    ...
    public function action_link($links)
    {
        $links = array_merge(
            ...
            [
                '<a href="'.esc_url('https://whitewp.com/docs?utm_source=plugin_white_label&utm_content=plugins').'" target="_blank">'.__('Documentation', 'white-label').'</a>',
            ],
            $links
        );
        return $links;
    ...
    public function settings($get_part = false)
    {
        ...
        $fields['white_label_general'] = [
            ...
            [
                ...
                updates, and more from all normal administrators. <a href="https://whitewp.com/docs/features/what-are-white-label-administrators?utm_source=plugin_white_label&utm_content=general" target="_blank">Learn more about White Label Administrators</a>.', 'white-label'),
                'type' => 'subheading',
                'class' => 'subheading',
            ],
            [
        ...
        $desc_sidebar_menus_section = __('Hide sidebar menu items for non-White Label Administrators. Rename sidebar menus by upgrading to <a href="https://whitewp.com/?utm_source=plugin_white_label&utm_content=sidebar_menus" target="_blank">White Label Pro</a>.', 'white-label');

        $fields['white_label_menus_plugins'] = [
            [
                'name' => 'hidden_plugins_section',
                'label' => __('Plugins', 'white-label'),
                'desc' => __('Hide the selected plugins from the plugin page. Only White Label Administrators will be able to see the selected plugins and their updates in the plugins list.', 'white-label'),
                'type' => 'subheading',
                'class' => 'subheading',
            ],
            [
        ...
        $desc_remove_widgets_section = __('Remove widgets from the admin dashboard. Remove individual widgets by upgrading to <a href="https://whitewp.com/?utm_source=plugin_white_label&utm_content=remove_widgets" target="_blank">White Label Pro</a>.', 'white-label');
        ...
        $sidebars = [
            'support' => [
                ...
                'content' => __('Our <a href="https://whitewp.com/docs?utm_source=plugin_white_label&utm_content=documentation" target="_blank">documentation</a> has detailed information on White Label\'s features. We recommend viewing this first if you are having issues.', 'white-label'),
            ],
            'feature_request' => [
                'id' => 'feature_request',
    ...
    public function scripts($hook)
    {
        ...
        // White Label
        wp_enqueue_style('white-label-White Label-css', plugins_url('assets/css/white-label.css', dirname(__FILE__)), null, '2.3.0');
        wp_enqueue_script('white-label-White Label-js', plugins_url('assets/js/white-label.min.js', dirname(__FILE__)), ['jquery'], '2.3.0');
    }
}
